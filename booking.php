...
<?php
  ...
  if (isset($_SESSION['username'])){
   ...
   if (isset($_POST['place_order'])) {
    ...
    VALUES ('$userID','$mechanic', '$firstName', '$lastName','$address','$carlicense','$appointment','$telephone','$phone','$state','$city','$postCode','Processing')";
...
<!-- 
       ...
       <button type="submit"  name="place_order" style="background-color: lightblue ;" class="btn btn-primary center-block"><?php echo "Confirm"?></button>
  </div>

<div>
<h1 style="text-align: center;" class="adminlay">Available Mechanic</h1>
<p  class="adminlay">Each mechanic can handle upto 5 appointments.<br>Please Check the list of avilable mechanic before placing your request.</p>
    <?php 
        for ($i=1; $i < 6; $i++) { 
          echo '
            <div class="progress" style="background-color: yellow;">
              <div class="progress-bar progress-bar-striped" role="progressbar" style="color:white; background-color: orange; width: ' . $avaiableMechanic[$i]*20 . '%" aria-valuenow="' . $avaiableMechanic[$i]*20 . '" aria-valuemin="0" aria-valuemax="100">Mechanic ' . $i . '
              </div>
            </div>
          ';
        }
