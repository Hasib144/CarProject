...
<body>
  ...
  ?>
  <nav class="navbar navbar-inverse navbar-fixed-top " style="background-color: orange; text-transform: uppercase; border-bottom: 1px solid white;">
      <div class="container-fluid">
        ...
        ">
            <li class="active"><a href="index.php"><span class="glyphicon glyphicon-home"></span> Homepage</a></li>
            <li><a href="booking.php">Make an Appointment</a></li>
  ...
  <?php  if (isset($_SESSION['username'])) { 
    ...
    echo '<li><a onclick="" href="registered.php"><i class="bi bi-save"></i> Last Appointment</a></li>
